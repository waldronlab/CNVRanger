...
We group the calls by sample ID, resulting in a `GRangesList` data structure.
Each element of the list thus corresponds to a sample and contains the genomic 
