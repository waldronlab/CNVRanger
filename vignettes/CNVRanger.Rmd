...
It is important to note that the `r Biocpkg("CNVRanger")` package assumes its input dataset to contain CNV calls previously filtered by quality within 
...
```{r getBtGenes2}
ahEdb <- ahDb[["AH60948"]]
bt.genes <- GenomicFeatures::genes(ahEdb)
