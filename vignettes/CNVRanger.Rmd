...
On the other hand, CNVs can also be computationally inferred from SNP-arrays and 
next-generation sequencing data.

The technologies for CNV detection have in common that they report, for each
