...
## Alternatively, if only one population is being tested, GRangesList can be used instead
cnvs <- read.table(file.path(data.dir, "CNVOut.txt"), sep = "", header = TRUE)  ### CNV table 
cnvs <- makeGRangesListFromDataFrame(cnvs, 
