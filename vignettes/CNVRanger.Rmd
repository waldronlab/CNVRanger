...
and also be computationally inferred from SNP-arrays and next-generation sequencing data.
...
requires calls to sufficiently with one another as e.g. used by 
